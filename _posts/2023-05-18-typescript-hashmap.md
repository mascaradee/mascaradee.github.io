...
title: '[typescript] hashMap and class practice'
categories:
  - typescript
tags:
  - hashMap
...
프로퍼티 앞에 `readonly`를 붙여 주면 어디서든 접근은 할 수 있지만 수정은 불가능하다. 
...
kimchi.def = '세계의 음식' // error: Cannot assign to 'def' because it is a read-only property.
```
